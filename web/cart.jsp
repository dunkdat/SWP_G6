                                    ...
                                    <div class="row g-0">
                                        <div class="col-lg-12">
                                            <div class="p-5">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${fn:startsWith(entry.key, 'cart-')}">
                                                            ...
                                                            <div class="row mb-4 d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div class="col-md-1 col-lg-1 col-xl-1">
                                                                    <img src="${product.link_picture}" class="img-fluid rounded-3" alt="${product.name}">
                                                                </div>
                                                                <div class="col-md-3 col-lg-3 col-xl-3">
                                                                    <h6 class="text-muted">${product.category}</h6>
                                                                    <h6 class="mb-0">${product.name}</h6>
                                                                    <p class="small mb-0">${product.color}  
                                                ...
                                                <div class="pt-5">
                                                    <h6 class="mb-0"><a href="homepage" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Back to shop</a></h6>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card bg-primary text-white rounded-3">
                                                <c:if test="${sessionScope.current_user != null}">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <button type="submit" class="btn btn-warning btn-block btn-lg">Complete Order</button>
                                                    </div>
                                                </c:if>
                                                <c:if test="${sessionScope.current_user == null}">
                                                    <div class="alert alert-warning text-center" role="alert">
                                                        Bạn cần đăng nhập để thanh toán. <a href="login" class="alert-link">Đăng nhập ngay</a>.
                                                    </div>
                                                </c:if>
                                            </div>
                                        </div>
